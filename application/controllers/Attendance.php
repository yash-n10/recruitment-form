...
class Attendance extends CI_Controller {
	...
	{	
		...
		$paymentquery = $this->db->query("SELECT Sum(adm.total_amount) cnt,app.reg_id,adm.registered_id FROM adm_transaction_zoned adm,application_form_zoned app where adm.paid_status='1' AND adm.status='Y' and adm.response_message='Success' and adm.registered_id=app.reg_id and  app.job_center1='KARANPURA TANDWA'")->result();
		...
		$pgt_eng_count = $this->db->query("SELECT COUNT(application_form_zoned.form_no) cnt FROM application_form_zoned,adm_transaction_zoned where application_form_zoned.teaching_post='PGT' AND application_form_zoned.pgt_teaching='ENGLISH' and adm_transaction_zoned.paid_status=1 and adm_transaction_zoned.registered_id=application_form_zoned.reg_id and  application_form_zoned.job_center1='KARANPURA TANDWA'and  application_form_zoned.job_center1='KARANPURA TANDWA'")->result();

		$pgt_phy_count = $this->db->query("SELECT COUNT(application_form_zoned.form_no) cnt FROM application_form_zoned,adm_transaction_zoned where application_form_zoned.teaching_post='PGT' AND application_form_zoned.pgt_teaching='PHYSICS' and adm_transaction_zoned.paid_status=1 and adm_transaction_zoned.registered_id=application_form_zoned.reg_id and  application_form_zoned.job_center1='KARANPURA TANDWA'and  application_form_zoned.job_center1='KARANPURA TANDWA'")->result();
...
//prt
		...
		$nonteaching_off_super_count =$this->db->query("SELECT COUNT(application_form_zoned.form_no) cnt FROM application_form_zoned,adm_transaction_zoned where application_form_zoned.teaching_cat='NON-TEACHING' AND application_form_zoned.non_teaching='OFFICE SUPERINTENDENT' and adm_transaction_zoned.paid_status=1 and adm_transaction_zoned.registered_id=application_form_zoned.reg_id and  application_form_zoned.job_center1='KARANPURA TANDWA'and  application_form_zoned.job_center1='KARANPURA TANDWA'")->result();

		$nonteaching_nur_count = $this->db->query("SELECT COUNT(application_form_zoned.form_no) cnt FROM application_form_zoned,adm_transaction_zoned where application_form_zoned.teaching_cat='NON-TEACHING' AND application_form_zoned.non_teaching='NURSE' and adm_transaction_zoned.paid_status=1 and adm_transaction_zoned.registered_id=application_form_zoned.reg_id and  application_form_zoned.job_center1='KARANPURA TANDWA'and  application_form_zoned.job_center1='KARANPURA TANDWA'")->result();
		$nonteaching_recp_count = $this->db->query("SELECT COUNT(application_form_zoned.form_no) cnt FROM application_form_zoned,adm_transaction_zoned where application_form_zoned.teaching_cat='NON-TEACHING' AND application_form_zoned.non_teaching='RECEPTIONIST' and adm_transaction_zoned.paid_status=1 and adm_transaction_zoned.registered_id=application_form_zoned.reg_id and  application_form_zoned.job_center1='KARANPURA TANDWA'and  application_form_zoned.job_center1='KARANPURA TANDWA'")->result();
		$nonteaching_lib_count = $this->db->query("SELECT COUNT(application_form_zoned.form_no) cnt FROM application_form_zoned,adm_transaction_zoned where application_form_zoned.teaching_cat='NON-TEACHING' AND application_form_zoned.non_teaching='LIBRARIAN' and adm_transaction_zoned.paid_status=1 and adm_transaction_zoned.registered_id=application_form_zoned.reg_id and  application_form_zoned.job_center1='KARANPURA TANDWA'and  application_form_zoned.job_center1='KARANPURA TANDWA'")->result();
		...
		//print_r($sub);
		$array = array('view'=>'dashboard_attendance','page_title' => $page_title,'queryy'=>$query,'registercount'=>$registercount,'paymentquery'=>$paymentquery,'paymentapplication'=>$paymentapplication,'teachingcount'=>$teachingcount,'teachingTGTcount'=>$teachingTGTcount,'teachingPRTcount'=>$teachingPRTcount,'teachingPGTcount'=>$teachingPGTcount,'teachingNurserycount'=>$teachingNurserycount,

			'pgt_eng_count'=>$pgt_eng_count,'pgt_phy_count'=>$pgt_phy_count,'pgt_chm_count'=>$pgt_chm_count,'pgt_mth_count'=>$pgt_mth_count,'pgt_cse_count'=>$pgt_cse_count,'pgt_bio_count'=>$pgt_bio_count,'pgt_biotech_count'=>$pgt_biotech_count,'pgt_acc_count'=>$pgt_acc_count,'pgt_bus_stu_count'=>$pgt_bus_stu_count,'pgt_eco_count'=>$pgt_eco_count,
	...
	public function exportcsv_pgt_cse() {
		...
		$records = $this->db->query("SELECT application_form_zoned.teaching_post,application_form_zoned.teaching_cat,application_form_zoned.form_no,application_form_zoned.sub_form_no,application_form_zoned.pgt_teaching,application_form_zoned.fname,application_form_zoned.mname,application_form_zoned.lname,application_form_zoned.fathername,application_form_zoned.father_mname,application_form_zoned.father_lname,application_form_zoned.email,application_form_zoned.mobile,application_form_zoned.dob FROM application_form_zoned,adm_transaction_zoned where application_form_zoned.teaching_post='PGT' AND application_form_zoned.pgt_teaching='COMPUTER_SCIENCE' and adm_transaction_zoned.paid_status=1 and adm_transaction_zoned.registered_id=application_form_zoned.reg_id ")->result();
