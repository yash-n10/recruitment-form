	...
	<tr>
		...
		<th style="text-align:left;">DOB</th>
			...
			<tr>
				...
				<td style="text-align:left;"><?php echo $rec->teaching_post; ?></td>
				<td style="text-align:left;"><?php echo $rec->tgt_teaching; ?><?php echo $rec->prt_teaching; ?></td>
				<td style="text-align:left;"><?php echo $rec->fname; ?>&nbsp;<?php echo $rec->lname; ?>&nbsp;<?php echo $rec->lname; ?></td>
