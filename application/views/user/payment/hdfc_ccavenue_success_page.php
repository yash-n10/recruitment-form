...
table th{
    ...
    <center>
        <div style="width:60%;border:1px solid grey;background: floralwhite;margin-top: 120px;">
       ...
       <?php } else { 
                    ...
                    <!--<form action="testTxnStatus.php" method="POST">-->
                     ...
                     <table style="width:100%;padding-left: 2%;margin-top: 2%;">
                                    ...
                                    <tr> 
                                        <td colspan="2" style="margin-top:5%;padding-top: 8%;text-align: center;font-size: initial;">
                                            <a href="<?php echo base_url('user/dashboard');?>" class="alert-link">Go to home page</a>
                                        </td>
                                    </tr>
                                    <tr>
